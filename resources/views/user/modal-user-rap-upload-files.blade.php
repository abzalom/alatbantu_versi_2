    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div id="user-rap-file-modal-show-content" style="display: none">
                ...
                <form id="form-user-upload-file" action="/rap/opd/upload-data-dukung" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <ul class="mt-0 pt-0">
                                ...
                                <li>Kerangka Acuan Kerja (KAK) dan Rincian Anggaran Belanja (RAB) wjib di upload bersamaan</li>
                            </ul>
                        </div>
                        <hr>
                        <div class="row">
                            <div id="kak-form-control" class="mb-5 col-sm-12 col-md-12 col-lg-6" #>
                                ...
                                <small id="file_kak_error" class="text-danger"></small>
                            </div>
                            <div id="rab-form-control" class="mb-5 col-sm-12 col-md-12 col-lg-6">
                                ...
                                <small id="file_rab_error" class="text-danger"></small>
                            </div>
                            ...
                            <div id="link-pendukung-form-control" class="mb-5 col-sm-12 col-md-12 col-lg-6">
                                <label for="user-rap-link-file" class="form-label fw-bold">Link <i class="fa-brands fa-google-drive"></i> Google Drive (Jika ada)</label>
